	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'dad':
				...
				playAnim('idle');
			case 'sans':
				tex = Paths.getSparrowAtlas('Sans_assets');
				frames = tex;
			...
			case 'gaster':
				tex = Paths.getSparrowAtlas('GasterAssets');
				frames = tex;
				animation.addByPrefix('idle', 'Gaster Idle0', 24);
				animation.addByPrefix('singUP', 'Gaster Up0', 24);
				animation.addByPrefix('singRIGHT', 'Gaster Right0', 24);
				animation.addByPrefix('singDOWN', 'Gaster Down0', 24);
				animation.addByPrefix('singLEFT', 'Gaster Left0', 24);

				addOffset('idle');
				addOffset("singUP", 14, 30);
				addOffset("singRIGHT", 8, -46);
				addOffset("singLEFT", 55, -16);
				addOffset("singDOWN", 10, -42);

				playAnim('idle');
			case 'pie':
				tex = Paths.getSparrowAtlas('Papyrus_assets');
				frames = tex;
				animation.addByPrefix('idle', 'Papyrus Idle', 24);
				...
				playAnim('idle');
			case 'chara':
				tex = Paths.getSparrowAtlas('Chara_Assets');
				frames = tex;
				...
				addOffset("singRIGHT", -10, 1);
				addOffset("singLEFT", 111, 5);
				addOffset("singDOWN", 30, 7);

				playAnim('idle');
			case 'flowey':
				tex = Paths.getSparrowAtlas('Flowey_assets');
				frames = tex;
				animation.addByPrefix('idle', 'Flowey Idle', 24);
				animation.addByPrefix('singUP', 'Flowey Up', 24);
				animation.addByPrefix('singRIGHT', 'Flowey Right', 24);
				animation.addByPrefix('singDOWN', 'Flowey Down', 24);
				animation.addByPrefix('singLEFT', 'Flowey Left', 24);

				addOffset('idle', 150, 170);
				addOffset("singUP", 163, 170);
				addOffset("singRIGHT", 40, 170);
				addOffset("singLEFT", 141, 170);
				addOffset("singDOWN", 110, 170);

				playAnim('idle');
				setGraphicSize(Std.int(width * 2));
			case 'sans2':
				tex = Paths.getSparrowAtlas('Sans_assets2');
				frames = tex;
			...
			case 'sans3':
				tex = Paths.getSparrowAtlas('Sans_assets3');
				frames = tex;
